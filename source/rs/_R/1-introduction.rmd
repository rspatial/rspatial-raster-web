...
This book provides a short introduction to satellite data analysis with R. Before reading this you should first learn the [basics of the raster package](http://rspatial.org/raster/). 
