...
The set of predictor variables (rasters) can be used to make a `RasterStack`, which is a collection of `RasterLayer' objects (see the [Spatial Data tutorial](../../spatial/4-rasterdata.html) for more info. 
