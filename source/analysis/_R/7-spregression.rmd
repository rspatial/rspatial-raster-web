...
You can [download the data here](https://biogeo.ucdavis.edu/data/rspatial/houses2000.rds) or with the script below. 

```{r getData}
dir.create('data', showWarnings = FALSE)
filename <- 'houses2000.rds'
...
Here I show a how to do spatial regression with a spatial lag model (lagsarlm)
