...
Here is an example of GWR with California precipitation data.  Get the data with the script above, or download it here: (precipitation data](https://biogeo.ucdavis.edu/data/rspatial/precipitation.csv) and [counties](https://biogeo.ucdavis.edu/data/rspatial/counties.rds).
