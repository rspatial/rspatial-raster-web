...
You can download the data used in the examples here: [precipitation](https://biogeo.ucdavis.edu/data/rspatial/precipitation.csv), [counties](https://biogeo.ucdavis.edu/data/rspatial/counties.rds), [airqual](https://biogeo.ucdavis.edu/data/rspatial/airqual.csv), or with the script below.
