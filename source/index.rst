...
.. topic:: 1. `Introduction to R <intr>`__
  ...
  Start here if you have never used *R*, or if you need a refresher. `pdf </_sources/intr/rst/IntroductiontoR.pdf>`__ 
  

.. topic:: 2. `Spatial data manipulation with R <spatial>`__

  Read this to learn about the basics of reading, writing, and manipulating spatial data. `pdf <../../_sources/spatial/rst/Spatialdata.pdf>`__
...
.. topic:: 5. `Case studies <cases>`__
   ...
   `pdf <../../_sources/cases/rst/cases.pdf>`__
