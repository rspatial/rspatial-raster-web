...
You can download the data here: [auctb](https://biogeo.ucdavis.edu/data/rspatial/auctb.rds), or with the script below.
...
Read the Auckland data (download [here](data/auctb.rds)).
