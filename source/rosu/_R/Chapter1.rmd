...
There is only one numerical example in this chapter, and it is a complicated one. I reproduce it here anyway, perhaps you can revisit it wnen you reach the end of the book (and you will be amazed to see how much you have learned!).
...
Thoughout this book, we will use data that is installed with the `rspatial` package. To install this package (from github) you can use the `install_github` function from the `devtools` package (so you may need to run `install.packages("devtools")` first.
