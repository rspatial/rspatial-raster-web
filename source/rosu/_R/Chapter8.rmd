...
Download the data for this lesson here: download here: [auctb](https://biogeo.ucdavis.edu/data/rspatial/auctb.rds), [counties](https://biogeo.ucdavis.edu/data/rspatial/counties.rds), [precipitation](https://biogeo.ucdavis.edu/data/rspatial/precipitation.rds). Or with the script below.
...
See [this page](http://rspatial.org/analysis/rst/6-local_regression.html) for a more detailed example of Geographically weighted regression.
